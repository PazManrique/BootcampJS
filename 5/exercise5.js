/*EJERCITACION 5
En España, el cálculo de la letra del Documento Nacional de Identidad (DNI) es un proceso matemático
...
Por lo tanto si el resto de la división es 0, la letra del DNI es la T y si el resto es 3 la letra es la A.
...
1. Pista: si se quiere pedir directamente al usuario que indique su número y su letra, se puede utilizar la función prompt()
...
let dni = prompt("Ingrese su número de DNI sin la letra");
let letterUser = prompt("Escribe la letra de tu DNI en mayusculas").toUpperCase();
